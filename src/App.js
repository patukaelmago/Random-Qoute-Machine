      ...
      {darkMode ?
        <div className='h-screen flex flex-col items-center bg-white '>
          <div id="container" className="container flex flex-col p-2 items-center gap-4 ">
            <button
              className='bg-lime-500 p-2 rounded-md mt-2  shadow-md border-gray-900'
          ...
          <div id="wrapper" className='  rounded-md m-2 bg-lime-500 shadow-md'>
            <div className="buttons text-center m-4  ">
              <button className='butt mr-4 text-md  bg-blue-700 rounded-md p-2 font-semibold text-white' id="new-quote" onClick={getQuote}>
                New Quote
              </button>
            </div>
          ...
          <div className='text-center '>
            <a
              ...
              id="tweet-quote"
            >
              <i className="fa fa-twitter text-4xl text-blue-700 mt-2 "><p className='text-sm'>Share on Twitter!</p></i>
            </a>
          </div>
        ...
        <div className='h-screen flex flex-col items-center bg-gray-900 '>
          <div id="container" className="container flex flex-col p-2 items-center gap-4 ">
            <button
              className='bg-blue-700 p-2 rounded-md mt-2  shadow-md border-gray-900'
              onClick={toggleDarkMode}>{darkMode ? <i className="bi bi-lamp bi-3x"></i> : <i className="bi bi-lamp-fill bi-3x"></i>}</button>
          ...
          <div id="wrapper" className='  rounded-md m-2 bg-blue-700 shadow-md'>
            <div className="buttons text-center m-4  ">
              <button className='butt mr-4 text-md  bg-lime-500 rounded-md p-2 font-semibold text-gray-900' id="new-quote" onClick={getQuote}>
                New Quote
              </button>
            </div>
          ...
          <div className='text-center '>
            <a
              ...
              id="tweet-quote"
            >
              <i className="fa fa-twitter text-4xl text-lime-500 mt-2 "><p className='text-sm'>Share on Twitter!</p></i>
            </a>
          </div>
